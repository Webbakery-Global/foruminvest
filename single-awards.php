        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="project_slider">
                    <?php
                    $award_galerij = get_field('award_galerij');
                    if ($award_galerij) : ?>

                        <?php foreach ($award_galerij as $image) : ?>
                            <div class="slide">
...
<section id="project_content">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-lg-6">
                <?= !empty($img = get_field('afbeelding_onder_de_slider_award_1')) ? wp_get_attachment_image($img['id'], 'large', false, ['class' => 'top image']) : '' ?>
                <?= !empty($img = get_field('afbeelding_onder_de_slider_award_2')) ? wp_get_attachment_image($img['id'], 'large', false, ['class' => 'bottom image']) : '' ?>
